...
(defmethod active-tables :jdbc-sql [driver metadata]
...
(defmethod excluded-schemas :jdbc-sql [_] nil)
...
(defmulti column->special-type
  ...
  (fn [driver native-type _] [(driver/dispatch-on-driver driver) native-type])
  :hierarchy #'driver/hierarchy)

(defmethod column->special-type :jdbc-sql [_ _ _] nil)
