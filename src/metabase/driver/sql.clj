...
(defmethod driver/supports? [:metabase.driver/sql-jdbc :basic-aggregations]              [_ _] true)
...
(defmethod driver/supports? [:metabase.driver/sql-jdbc :native-query-params]             [_ _] true)
